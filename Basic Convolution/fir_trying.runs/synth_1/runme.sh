...
HD_PWD='C:/Digital Filters/DS_Project_ANC_Digital_Filters/Basic Convolution/fir_trying.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wienerfilter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wienerfilter.tcl
