...
HD_PWD='C:/Digital Filters/DS_Project_ANC_Digital_Filters/Basic Convolution/fir_trying.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wienerfilter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wienerfilter.tcl -notrace
