...
HD_PWD='C:/Digital Filters/DS_Project_ANC_Digital_Filters/Week_1/Week_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_read.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source memory_read.tcl
