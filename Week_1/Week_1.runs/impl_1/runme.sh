...
HD_PWD='C:/Digital Filters/DS_Project_ANC_Digital_Filters/Week_1/Week_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log memory_read.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source memory_read.tcl -notrace
